        ...
        <div className="sidebar-wrap search-form">
          <aside id="secondary" className="widget-area">
            ...
            <section className="widget widget_meta">
              ...
              <ul>
                <li>
                  <a href="https://Cristianok.dev">Personal Site</a>
                </li>
                <li>
                  <a href="https://Cristianok.hashnode.dev/">Hashnode</a>
                </li>
                <li>
                  <a href="https://linkedin.com/in/Cristiano-howard">
                    LinkedIn
                  </a>
                </li>
                <li>
                  <a href="http://twitter.com/dev_Cristianok">X (twitter)</a>
                </li>
              </ul>
            </section>
          </aside>
