...
const bio = `<p>
👋 <strong>I am Cristiano</strong>, a Frontend Developer from Florida. Passionate about crafting captivating digital experiences through code, I am a skilled Frontend Web Developer with a keen eye for design & a knack for turning ideas into interactive web solutions.
</p>`;
    ...
    <Layout bg={"gradient"}>
      ...
      <Home>
        ...
        <div className="profile no-photo">
          ...
          />
          {/* profile titles */}
          <div className="title">Cristiano Howard</div>
          ...
          <div className="social">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://dribbble.com/cristianosilva009"
            >
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://twitter.com/dev_Cristianok"
            >
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/cristianosilva009"
            >
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/cristiano-nerys-silva-7b247733a/"
            >
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://medium.com/@Cristianokdev"
            >
